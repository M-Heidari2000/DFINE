...
def train_cost(
    ...
    for update in tqdm(range(args.num_updates)):    
        ...
        for t in range(1, args.chunk_length):
            ...
            z_filter_loss += nn.MSELoss()(z_decoder(mean), z[t])
