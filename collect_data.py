...
if __name__ == "__main__":
    ...
    parser.add_argument("--domain-name", type=str, default="pendulum", help="domain name of the control suite env")
    parser.add_argument("--task-name", type=str, default="swingup", help="task name of the control suite env")
